        ...
        <div className='max-w-4xl mx-auto p-6 md:p-8 backdrop-blur-lg rounded-xl shadow-lg bg-white/95 text-gray-900 dark:bg-gray-900/90 dark:text-gray-100'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-lg mb-4 text-gray-700 dark:text-gray-300'>
              In general, there are three different kinds of scholarship
          ...
          <div className='mb-8 p-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <p className='mb-4 text-gray-700 dark:text-gray-300'>
              These scholarships are issued by the United States government in
              one way or another.
            </p>
            <p className='mb-4 text-gray-700 dark:text-gray-300'>
            ...
            <p className='text-gray-700 dark:text-gray-300'>
              This is by no means an exhaustive list. There are plenty of other
              government-sponsored scholarships. Visit{' '}
          ...
          <div className='mb-8 p-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <p className='mb-4 text-gray-700 dark:text-gray-300'>
              These scholarships are issued by your specific university or
              college, normally managed by the Office of International Programs,
              Study Abroad Office, or Financial Aid Office.
            </p>
            <p className='mb-4 text-gray-700 dark:text-gray-300'>
              Available scholarships differ significantly between institutions.
              It's essential to get in contact with Study Abroad advisors at
              your school for the most accurate and relevant information!
            </p>
            <p className='text-gray-700 dark:text-gray-300'>
              For UT Tyler students, visit {/* Use dark: variants for link */}
              <a
                className='underline text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300'
          ...
          <div className='mb-8 p-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <p className='mb-4 text-gray-700 dark:text-gray-300'>
              These scholarships typically come from private organizations,
              foundations, or companies with a mission related to international
              education, specific fields of study, or supporting particular
            ...
            <p className='text-gray-700 dark:text-gray-300'>
              ...
              Deadlines and eligibility vary widely. Again, your university's
              Study Abroad office is often the best resource for curated lists
              and guidance on finding reputable third-party funding. Online
              scholarship search engines can also be helpful.
            </p>
          </div>
          ...
          <div className='text-center mt-8 p-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <p className='text-lg text-gray-700 dark:text-gray-300'>
              ...
              page to track deadlines and manage the scholarships listed above
              (and more!).
            </p>
          </div>
        </div>
