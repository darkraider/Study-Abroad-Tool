...
export default function Layout ({ children, backgroundImageSrc }: LayoutProps) {
  ...
  return (
    <>
      ...
      <div
        className={`relative min-h-screen w-full overflow-hidden bg-transparent text-gray-900 dark:text-gray-100`}
      >
        ...
        <nav
          className={`fixed top-0 left-0 right-0 p-4 flex items-center justify-between shadow-lg z-30 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm`}
        >
          <button
            ...
            <>
              ...
              >
                ...
                <ul className='space-y-1 overflow-y-auto flex-grow'>
                  <li
                    onClick={() => navigateTo('/')}
                    className={`text-base font-medium cursor-pointer p-3 rounded-lg transition-colors border-b border-gray-200 dark:border-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-400`}
                  >
                    Home
                  </li>
                  <li
                  ...
                  <li
                    onClick={() => navigateTo('/scholarshipinfo')}
                    className={`text-base font-medium cursor-pointer p-3 rounded-lg transition-colors border-b border-gray-200 dark:border-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-400`}
                  >
                    Scholarship Info
                  </li>
                  <li
                    ...
                    className={`text-base font-medium cursor-pointer p-3 rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-400`}
                  >
                    Scholarship Planner
                  </li>
                </ul>
                ...
                <div className='mt-auto pt-4 border-t border-gray-200 dark:border-gray-700/50 text-center text-xs text-gray-500 dark:text-gray-400'>
                  Study Abroad Tool v1.1 by{' '}
                  <Link
                    rel='noopener noreferrer'
                    target='_blank'
                    href='https://www.linkedin.com/in/moorela/'
                  >
                    Levi Moore
                  </Link>
                </div>
        ...
        <main className='relative z-10 px-4 sm:px-6 lg:px-8 overflow-y-auto pt-20 pb-10'>
          {children}
        </main>
      </div>{' '}
